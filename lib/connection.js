...
Connection.prototype.connect = function (timeout) {
    ...
    console.log('XXXXXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXXXXX ');
    console.log('XXXXXXXXXXXXXXXXXXXXXXX Connection.prototype.connect = function (timeout) { ' + JSON.stringify(this.ssl));
    console.log('XXXXXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXXXXX ');
    ...
    self.connecting = Promise.race([
        console.log('XXXXXXX connecting');
        ...
        new Promise(function (resolve, reject) {
            console.log('XXXXXXX connecting in promise');
            if (self.socket) {
                self.socket.destroy();
            }
            ...
            if(_.isEmpty(self.ssl)){
                console.log('XXXXXXX connecting in promise - ssl is empty');

                self.socket = net.connect(self.port, self.host);
            }else{
                console.log('XXXXXXX connecting in promise - ssl is not empty : ' + JSON.stringify(self.ssl));
                self.socket = tls.connect(self.port, self.host, self.ssl);                
            }
